...
$contentButtonsize = isMobileDevice() ? "width='100' height='100'" : "width='60' height='60'";

$loggedIn = "
<form action='?' method='GET'>
    <input type='hidden' name='action' value='addContent'>
    <button>
        <svg xmlns='http://www.w3.org/2000/svg' class='fill-gray-400 text-white' $contentButtonsize viewBox='0 0 24 24'>

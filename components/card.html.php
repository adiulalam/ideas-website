<div class="flex flex-col my-auto items-center bgimg bg-cover p-10">
    <div class="max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="mb-3">
            <p class="mr-2 text-xs float-right italic font-light text-white-900 dark:text-gray-400">01/01/2020</p>
            <p class="ml-4 text-base float-left font-normal text-white-500 dark:text-gray-400">By User</p>
        </div>
        ...
        <div class="p-5 mt-4">
            ...
            <div>
                ...
                <p class="inline-flex mr-1 float-right items-center py-2 px-3 text-sm font-medium text-center text-white">10</p>

            ...
            <div class='relative p-4 w-full max-w-md h-full md:h-auto'>
                <div class='relative rounded-lg shadow bg-gray-700'>
                    ...
                    <div class='p-6 text-center'>
                        ...
                        <h3 class='mb-5 text-lg font-normal text-gray-400'>Are you sure you want to delete this Idea?</h3>
                        <form action='?' method='post'>
                            <input type='hidden' name='ID' value='$IdeaID'>
                            <button data-modal-toggle='$IdeaID' type='submit' name='action' value='Delete' class='text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2'>
                                Yes, I'm sure
                            </button>
                        <button data-modal-toggle='$IdeaID' type='button' class='focus:ring-4 focus:outline-none rounded-lg border text-sm font-medium px-5 py-2.5 focus:z-10 bg-gray-700 text-gray-300 border-gray-500 hover:text-white hover:bg-gray-600 focus:ring-gray-600'>No, cancel</button>
                        </form>
                    </div>
                </div>
            </div>
